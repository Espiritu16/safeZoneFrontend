...
describe('UsuarioDenunciasPage', () => {
  ...
  it('opens a compact case consultation panel for linked victim records', () => {
    predenunciasService.listMine.mockReturnValue(of([
      {
        id: 'pred-abc12345',
        estado: 'PENDIENTE',
    ...
    expect(fixture.nativeElement.textContent).toContain('Consulta de caso');
    expect(fixture.nativeElement.textContent).toContain('Resumen del expediente');
    expect(fixture.nativeElement.textContent).toContain('PD-PRED-ABC');
