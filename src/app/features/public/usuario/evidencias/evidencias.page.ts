...
export class UsuarioEvidenciasPage implements OnInit, OnDestroy {
  ...
  protected evidenceName(evidencia: VictimaHistorialItem): string {
    const name = this.metadata(evidencia, 'nombreOriginal');
    return name === 'No vinculado' ? evidencia.titulo : name;
  }
